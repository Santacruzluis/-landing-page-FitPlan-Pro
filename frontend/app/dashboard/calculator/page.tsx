...
import { Calculator, Dumbbell, Target, TrendingUp, TrendingDown } from "lucide-react"
      ...
      <header className="border-b border-white/10 bg-black/20 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-slate-900 dark:text-white">FitPlan Pro</span>
          </Link>
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/dashboard/calculator" className="text-slate-900 dark:text-white font-medium">
              Calculadora
            </Link>
            <Link
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="text-slate-900 dark:text-white">Género</Label>
                  <Select
              ...
              <div className="space-y-2">
                <Label className="text-slate-900 dark:text-white">Nivel de Actividad</Label>
                <Select
              ...
              <div className="space-y-3">
                <Label className="text-slate-900 dark:text-white">Objetivo</Label>
                <RadioGroup value={formData.goal} onValueChange={(value) => setFormData({ ...formData, goal: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="lose" id="lose" className="border-white/20 text-purple-400" />
                    <Label htmlFor="lose" className="text-slate-900 dark:text-white flex items-center">
                      <TrendingDown className="mr-2 h-4 w-4 text-red-400" />
                      Perder peso
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="maintain" id="maintain" className="border-white/20 text-purple-400" />
                    <Label htmlFor="maintain" className="text-slate-900 dark:text-white flex items-center">
                      <Target className="mr-2 h-4 w-4 text-blue-400" />
                      Mantener peso
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="gain" id="gain" className="border-white/20 text-purple-400" />
                    <Label htmlFor="gain" className="text-slate-900 dark:text-white flex items-center">
          ...
          {results && (
            <div className="space-y-6">
              <Card className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border-purple-600/30">
                <CardHeader>
                  <CardTitle className="text-slate-900 dark:text-white">Tus Resultados</CardTitle>
                  <CardDescription className="text-gray-500 dark:text-gray-300">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-slate-900 dark:text-white">{results.bmr}</p>
                      <p className="text-sm text-gray-500 dark:text-gray-300">BMR (Metabolismo Basal)</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-slate-900 dark:text-white">{results.tdee}</p>
                      <p className="text-sm text-gray-500 dark:text-gray-300">TDEE (Gasto Total)</p>
                    </div>
                  </div>
                  <div className="text-center border-t border-white/10 pt-4">
                    <p className="text-3xl font-bold text-purple-300">{results.goalCalories}</p>
                    <p className="text-gray-500 dark:text-gray-300">Calorías para tu objetivo</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="text-slate-900 dark:text-white">Macronutrientes Diarios</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-red-400">{results.protein}g</p>
                      <p className="text-sm text-gray-500 dark:text-gray-300">Proteínas</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-400">{results.carbs}g</p>
                      <p className="text-sm text-gray-500 dark:text-gray-300">Carbohidratos</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-yellow-400">{results.fats}g</p>
                      <p className="text-sm text-gray-500 dark:text-gray-300">Grasas</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="text-slate-900 dark:text-white">Recomendaciones</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3 text-gray-500 dark:text-gray-300">
                    <p>• Consume {results.protein}g de proteína distribuida en 4-5 comidas</p>
